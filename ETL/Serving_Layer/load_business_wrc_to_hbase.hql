CREATE EXTERNAL TABLE qi_yelp_business_wrc_not_orc_3(
    business_id String,
    name String,
    categories String,
...
-- LOAD DATA INPATH 'hdfs:///user/qizhu/output/business_w_active_review_count' OVERWRITE INTO TABLE qi_yelp_business_wrc_not_orc_2;
LOAD DATA INPATH 'hdfs:///apps/hive/warehouse/qi_yelp_business_wrc_not_orc' OVERWRITE INTO TABLE qi_yelp_business_wrc_not_orc_2;

CREATE TABLE qi_yelp_business_wrc_hbase_sync_2(
    business_id String,
    name String,
    categories String,
...
TBLPROPERTIES ("hbase.table.name" = "qi_yelp_business_wrc_hbase_sync_2");

INSERT OVERWRITE TABLE qi_yelp_business_wrc_hbase_sync_2 SELECT * FROM qi_yelp_business_wrc_not_orc_2;
