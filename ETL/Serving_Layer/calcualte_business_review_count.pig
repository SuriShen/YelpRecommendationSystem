--load all the data
review_row = LOAD 'hdfs:///apps/hive/warehouse/qi_yelp_review_not_orc/part-m-00000' USING PigStorage('\u0001')
...
user_row = LOAD 'hdfs:///apps/hive/warehouse/qi_yelp_user_not_orc/part-m-00000' USING PigStorage('\u0001')
...
STORE business_review_count_w_active_user INTO 'hdfs:///user/qizhu/output/temp1' USING PigStorage('\u0001');
...
STORE business_review_count INTO 'hdfs:///user/qizhu/output/business_w_active_review_count' USING PigStorage('\u0001');
