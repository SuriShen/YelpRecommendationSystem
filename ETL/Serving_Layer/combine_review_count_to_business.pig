...
business_row = LOAD 'hdfs:///apps/hive/warehouse/qi_yelp_business_not_orc/part-m-00000' USING PigStorage('\u0001')
...
business_review_count_w_active_user = LOAD 'hdfs:///user/qizhu/output/temp1' USING PigStorage('\u0001') as (business_id:chararray, review_count_active_user:int, active_user_count:int);

business_review_count = LOAD 'hdfs:///user/qizhu/output/temp2' USING PigStorage('\u0001') as (business_id:chararray, review_count_all_user:int, all_user_count:int);
...
STORE business_w_both_user_row INTO 'hdfs:///user/qizhu/output/business_w_active_review_count' USING PigStorage('\u0001');
