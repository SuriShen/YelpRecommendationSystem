review_raw = LOAD 'hdfs:///apps/hive/warehouse/qi_yelp_review_not_orc' USING PigStorage('\u0001') 
...
STORE review_before_2010 INTO 'hdfs:///user/qizhu/output/review_before_2010' USING PigStorage('\u0001');
STORE review_2010_order INTO 'hdfs:///user/qizhu/output/review_2010_order' USING PigStorage('\u0001');
STORE review_2011_order INTO 'hdfs:///user/qizhu/output/review_2011_order' USING PigStorage('\u0001');
STORE review_2012_order INTO 'hdfs:///user/qizhu/output/review_2012_order' USING PigStorage('\u0001');
STORE review_2013_order INTO 'hdfs:///user/qizhu/output/review_2013_order' USING PigStorage('\u0001');
