json_user_raw_row = LOAD 'hdfs:///user/qizhu/input/qi_training_set_user.json'
...
STORE json_user_row_2 INTO 'hdfs:///user/qizhu/output/json_user_table' USING PigStorage('\u0001');
